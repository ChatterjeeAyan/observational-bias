...
def train(predictor, x, edge_index, split_edge, optimizer, batch_size):
    ...
    #os_train_edge = split_edge['train']['edge'].to(x.device)
    ...
    #neg_valid_nodes = list(set(neg_valid_edge_df[0].tolist()).union(set(neg_valid_edge_df[1].tolist())))
    pos_test_nodes = list(set(pos_test_edge_df[0].tolist()).union(set(pos_test_edge_df[1].tolist())))
    #neg_test_nodes = list(set(neg_test_edge_df[0].tolist()).union(set(neg_test_edge_df[1].tolist())))
    ...
    #print('Valid-test nodes: ', len(valid_minus_test_nodes))

    #print('Train-valid-test nodes: ' , len(set(train_nodes).difference(set(valid_plus_test_nodes))))
    #print('Test-train nodes: ', len(set(all_test_nodes).difference(set(train_nodes))))

    #print('Train-valid nodes: ' , len(set(train_nodes).difference(set(all_valid_nodes))))
    #print('Valid-train nodes: ', len(set(all_test_nodes).difference(set(train_nodes))))

    #pos_test_edge_inductive_df = pos_test_edge_df[~pos_test_edge_df[0].isin(train_nodes) & ~pos_test_edge_df[1].isin(train_nodes)]

    #print('Test-train edges: ', len(pos_test_edge_inductive_df))
