...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=500) ## Default is 20
    parser.add_argument('--eval_steps', type=int, default=1)
    parser.add_argument('--runs', type=int, default=13) ## Was 10
    ...
    x = torch.tensor(np.random.rand(x.shape[0],x.shape[1])).to(torch.float)
