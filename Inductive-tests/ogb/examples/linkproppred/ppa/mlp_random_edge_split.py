...
def main():
    ...
    pos_valid_edge = split_edge['valid']['edge'].to(device).cpu()
    neg_valid_edge = split_edge['valid']['edge_neg'].to(device).cpu()
    ...
    print('Val edges: ', len(valid_minus_test_edges)) 
    ...
    print('Train edges: ', len(train_edges_not_in_test_valid))
    print('Val edges: ', len(valid_minus_test_edges))
