...
def argument():
    ...
    parser.add_argument('--epochs', type=int, default=500) ## Default was 500
    parser.add_argument('--log_steps', type=int, default=1)
    parser.add_argument('--eval_steps', type=int, default=5)
    parser.add_argument('--runs', type=int, default=3) ## Default was 10
    parser.add_argument('--year', type=int, default=-1)
    parser.add_argument('--device', type=int, default=0)
    parser.add_argument('--use_lr_decay', type=str2bool, default=False)
    parser.add_argument('--use_node_feats', type=str2bool, default=True) ## Was False
...
def main():
    ...
    pos_train_nodes, pos_val_test_nodes = train_test_split(all_nodes, test_size=0.2, random_state=42876)
    pos_val_nodes, pos_test_nodes  = train_test_split(pos_val_test_nodes, test_size=0.5 ,random_state=88434)
